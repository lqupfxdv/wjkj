package com.example.equity.position.config;
...
@EnableJpaRepositories(basePackages="com.example.equity.position.dao")
public class DataConfig {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource,
		...
		emf.setPersistenceUnitName("trade");
		emf.setJpaVendorAdapter(jpaVendorAdapter);
		emf.setPackagesToScan("com.example.equity.position.po");
		return emf;
	}
